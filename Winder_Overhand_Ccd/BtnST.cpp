...
DWORD CButtonST::SetColor2(COLORREF bkColor, COLORREF fgColor,CFont *v_Font,BOOL bRepaint)
{
	this->SetColor(BTNST_COLOR_BK_OUT,bkColor);
	this->SetColor(BTNST_COLOR_BK_FOCUS,bkColor);
	this->SetColor(BTNST_COLOR_BK_IN,bkColor);
	this->SetColor(BTNST_COLOR_FG_OUT,fgColor);
	this->SetColor(BTNST_COLOR_FG_FOCUS,fgColor);
	this->SetColor(BTNST_COLOR_FG_IN,fgColor);
	
	this->SetFont(v_Font,TRUE);
...
DWORD CButtonST::SetBkColor(COLORREF crColor)
{
	//设置背景颜色
	SetColor(CButtonST::BTNST_COLOR_BK_OUT,crColor);	
	SetColor(CButtonST::BTNST_COLOR_BK_FOCUS,crColor);
	SetColor(CButtonST::BTNST_COLOR_BK_IN,crColor);

	//设置文字颜色
	SetColor(CButtonST::BTNST_COLOR_FG_OUT,RGB(255,255,255));
	SetColor(CButtonST::BTNST_COLOR_FG_FOCUS,RGB(255,255,255));
	SetColor(CButtonST::BTNST_COLOR_FG_IN,RGB(255,255,255));

	return BTNST_OK;
}

DWORD CButtonST::SetFontSize(int v_intSize)
{
	//设置字体
	m_Font.CreateFont(
		v_intSize,                       //字体大小
